...
class Rossmann(object):
    def __init__(self):
        self.home_path = '/Users/hallanmiranda/Documents/repos/projeto_portfolio/pa003-Rossman'
        self.competition_distace_scaler = pickle.load(open('parameter/competition_distance_scaler.pkl', 'rb'))
    ...
    def data_preparation(self, df5):
        ...
        df5['competition_distance'] = self.competition_distace_scaler.fit_transform(df5[['competition_distance']].values)
        ...
        return df5[ cols_selectedc] 

    def get_prediction(self, model, original_data, test_data):
        # predition 
        pred = model.presict( test_data )
